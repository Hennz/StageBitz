...
{
    /// <summary>
    /// Web page for booking details edit non-project.
    /// </summary>
    public partial class BookingDetailsEditNonProject : PageBase
    {
        #region Properties
        ...
        /// <summary>
        /// Gets the viewing company identifier.
        /// </summary>
        /// <value>
        ...
        public int ViewingCompanyId
        {
            get
            {
                if (ViewState["ViewCId"] == null)
                {
                    int companyId = 0;

                    if (Request["ViewCId"] != null)
                    {
                        int.TryParse(Request["ViewCId"], out companyId);
                    }

                    ViewState["ViewCId"] = companyId;
                }

                return (int)ViewState["ViewCId"];
            }
        }
